...
public class SeminarView extends javax.swing.JFrame {
   ...
   private QueryMethods qMethods = new QueryMethods();
     ...
     */
    public void fillSeminarTable(Seminar seminar) {
        Seminar = qMethods.findSeminar();
        String[] colname = {"Title", "Speaker", "StartDate"," EndDate", "CountVisitor", "Description", "Program"};
        DefaultTableModel defaultModel = new DefaultTableModel(colname, 0);

        defaultModel.setRowCount(0);
        for (int i = 0; i < Seminar.size(); i++) {
            defaultModel.addRow(new Object[]{Seminar.get(i).getId(),
                Seminar.get(i).getTitle(),
                Seminar.get(i).getSpeaker(),
                Seminar.get(i).getStartDate(),
                Seminar.get(i).getEndDate(),
                Seminar.get(i).getCountVisitor(),
                Seminar.get(i).getSeminariumDescription(),
                Seminar.get(i).getProgramDescription()});
        }
